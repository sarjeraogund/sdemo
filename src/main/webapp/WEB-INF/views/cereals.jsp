...
<div class="wrap">
  ...
  <div class="items">
        ...
        <div data-price="160" class="item">
            <img src="images/image/wheat.jpg" alt="apple" class="img-item"></img>
                <div class="info">
    ...
    <img alt="" width="1" height="1"
        ...
        <div data-price="60" class="item">
            <img src="images/image/maize.jpg" alt="jacket" class="img-item" ></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Maize</h3>
                    <h5>Rs.60</h5>
     ...
     <br>
        ...
        <div data-price="80" class="item">
            <img src="images/image/millet.jpg" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                  <h3>Millet</h3>
                    <h5>Rs.80</h5>
    ...
    <br>
         ...
         <div data-price="120" class="item">
            <img src="images/image/ragi.jpeg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Ragi</h3>
                    <h5>Rs.120</h5>
     ...
     <br>
         ...
         <div data-price="100" class="item">
            <img src="images/image/rice.jpg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Rice</h3>
                    <h5>Rs.100</h5>
     ...
     <br>
         ...
         <div data-price="140" class="item">
            <img src="images/image/sorghum.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Sorghum</h3>
                    <h5>Rs.140</h5>
     ...
     <br>
         ...
         <div data-price="150" class="item">
            <img src="images/image/sago.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Sago</h3>
                    <h5>Rs.150</h5>
     ...
     <br>
         ...
         <div data-price="90" class="item">
            <img src="images/image/semolina.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Semolina</h3>
                    <h5>Rs.90</h5>
