...
<div class="wrap">
  ...
  <div class="items">
        ...
        <div data-price="160" class="item">
            <img src="images/image/almonds.jpg" alt="apple" class="img-item"></img>
                <div class="info">
    ...
    <img alt="" width="1" height="1"
        ...
        <div data-price="60" class="item">
            <img src="images/image/cashewnut.jpg" alt="jacket" class="img-item" ></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Cashew nut</h3>
                    <h5>Rs.60</h5>
     ...
     <br>
        ...
        <div data-price="80" class="item">
            <img src="images/image/dates.jpg" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                  <h3>Dates</h3>
                    <h5>Rs.80</h5>
    ...
    <br>
         ...
         <div data-price="120" class="item">
            <img src="images/image/pista.jpg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Pistachio</h3>
                    <h5>Rs.120</h5>
     ...
     <br>
         ...
         <div data-price="100" class="item">
            <img src="images/image/prunes.jpg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Prunes</h3>
                    <h5>Rs.100</h5>
     ...
     <br>
         ...
         <div data-price="140" class="item">
            <img src="images/image/fig.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Fig</h3>
                    <h5>Rs.140</h5>
     ...
     <br>
         ...
         <div data-price="150" class="item">
            <img src="images/image/walnuts.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Walnuts</h3>
                    <h5>Rs.150</h5>
     ...
     <br>
         ...
         <div data-price="90" class="item">
            <img src="images/image/driedkiwi.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Dried Kiwi</h3>
                    <h5>Rs.90</h5>
