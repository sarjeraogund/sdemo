  ...
  <div class="items">
    ...
    <img alt="" width="1" height="1"
        ...
        <div data-price="60" class="item">
            <img src="images/image/marigold.jpg" alt="jacket" class="img-item" ></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Marigolds</h3>
                    <h5>Rs.60</h5>
     ...
     <br>
        ...
        <div data-price="80" class="item">
            <img src="images/image/jasminum.jpg" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
    ...
    <br>
         ...
         <div data-price="120" class="item">
            <img src="images/image/periwinklee.jpg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Periwinklee</h3>
                    <h5>Rs.120</h5>
     ...
     <br>
         ...
         <div data-price="100" class="item">
            <img src="images/image/anona.jpg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Anona Hexapetala</h3>
                    <h5>Rs.100</h5>
                     <select name="os0" id="os0">
     ...
     <br>
         ...
         <div data-price="140" class="item">
            <img src="images/image/hibiscus.jpeg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Hibiscus</h3>
                    <h5>Rs.140</h5>
     ...
     <br>
         ...
         <div data-price="150" class="item">
            <img src="images/image/cypressvine.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Cypress Vine</h3>
                    <h5>Rs.150</h5>
     ...
     <br>
         ...
         <div data-price="90" class="item">
            <img src="images/image/mimusops.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Mimusops elengi</h3>
                    <h5>Rs.90</h5>
                     <select name="os0" id="os0">
