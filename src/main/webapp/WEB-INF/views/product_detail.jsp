...
<div class="container">
		<div class="row">
			<h2>Fresho Apple-Washington</h2><br>
		</div>
		<div class="col-md-6">
		<div class="g">
        <ul id="glasscase" class="gc-start">
       		<li><img src="images/apple_pd.png" alt="Text" data-gc-caption="FRESH APPLE" /></li>
            <li><img src="images/apple_pd1.png" alt="Text" data-gc-caption="FRESH APPLEV" /></li>
      	</ul>
        </div>
        </div>
		<div class="col-md-6">
   	    <div class="major">
   	    	<div class="product-title">Fresho Apple - Washington</div>
			<div class="product-desc">The best apple ever...</div>
			<hr>
	...
	<div class="row">
        ...
        <div class="carousel-inner">
        	...
        	<div class="col-xs-12 col-sm-6 col-md-2">
              		<a href="#"><img src="images/peaa.png" class="img-responsive center-block"></a>
              		<h3 class="text-center">Pears</h3>
              		<h5 class="text-center">Rs.140</h5>
            		...
            		<option value="1000">1kg. approx 8,9 nos. Rs.140</option>
        				...
        				<div class="aa">
       						 <label for="quantity">Qty: </label>
						 	<input min="1" type="number" id="quantity" name="quantity" value="1" />
         				 	<style>#quantity { padding:2px; width:0px; border: 1px solid #555; }</style>
          ...
          <div class="item">
           <div class="col-xs-12 col-sm-6 col-md-2">
           		   <a href="#"><img src="images/o.png" class="img-responsive center-block"></a>
              		<h3 class="text-center">Fresh Oranges</h3>
              		<h5 class="text-center">Rs.120</h5>
              		<select name="os0" id="os0">
          ...
          <div class="item">
            <div class="col-xs-12 col-sm-6 col-md-2">
              		<a href="#"><img src="images/b.png" class="img-responsive center-block"></a>
              		<span class="badge">10%</span>
             		<h3 class="text-center">Banna</h3>
              		<h5 class="text-center">Rs.60</h5>
              		<select name="os0" id="os0">
          ...
          <div class="item">
            <div class="col-xs-12 col-sm-6 col-md-2">
           		   <a href="#"><img src="images/p.png" class="img-responsive center-block"></a>
              		<h3 class="text-center">Pomegranate</h3>
              		<h5 class="text-center">Rs.90</h5>
              		<select name="os0" id="os0">
          ...
          <div class="item">
            <div class="col-xs-12 col-sm-6 col-md-2">
              <a href="#"><img src="images/wat.png" class="img-responsive center-block"></a>
              <h3 class="text-center">Watermelon</h3>
              <h5 class="text-center">Rs.120</h5>
              <select name="os0" id="os0">
        ...
        <label for="quantity">Qty: </label>
          ...
          <div class="item">
            <div class="col-xs-12 col-sm-6 col-md-2">
              <a href="#"><img src="images/g.png" class="img-responsive center-block"></a>
