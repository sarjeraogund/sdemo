...
<div class="wrap">
  ...
  <div class="items">
        ...
        <div data-price="160" class="item">
            <img src="images/image/rajgira.jpg" alt="apple" class="img-item"></img>
                <div class="info">
                	 <p class="descroption">Fresho</p>
                    <h3>Amaranth Seeds</h3>
                    <h5>Rs.160</h5>
    ...
    <img alt="" width="1" height="1"
        ...
        <div data-price="60" class="item">
            <img src="images/image/badishep.jpg" alt="jacket" class="img-item" ></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Anise Seeds</h3>
                    <h5>Rs.60</h5>
     ...
     <br>
        ...
        <div data-price="80" class="item">
            <img src="images/image/tulas.jpg" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                  <h3>Basil Seeds</h3>
                    <h5>Rs.80</h5>
    ...
    <br>
         ...
         <div data-price="120" class="item">
            <img src="images/image/caraway.jpg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Caraway Seeds</h3>
                    <h5>Rs.120</h5>
     ...
     <br>
         ...
         <div data-price="100" class="item">
            <img src="images/image/cardamom.jpg" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
                    <h3>Cardamom</h3>
                    <h5>Rs.100</h5>
     ...
     <br>
         ...
         <div data-price="140" class="item">
            <img src="images/image/coriander.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
     ...
     <br>
         ...
         <div data-price="150" class="item">
            <img src="images/image/jire.JPEG"alt="jacket" class="img-item"></img>
                <div class="info">
                  <p class="descroption">Fresho</p>
                    <h3>Cumin Seeds</h3>
                    <h5>Rs.150</h5>
     ...
     <br>
         ...
         <div data-price="90" class="item">
            <img src="images/image/methi.jpg"alt="jacket" class="img-item"></img>
                <div class="info">
                    <p class="descroption">Fresho</p>
